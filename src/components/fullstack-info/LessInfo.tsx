    ...
    return (
        <div className={'block-info-inner'}>
            <p>
                ...
                sidebar, footer, list element, popup) становилась все менее увлекательнее, но все еще отнимала
                время. Хотелось писать css короче и гибче. Поэтому я заинтересовался выбором препроцессора.
                Глаз упал на Less (понравился синтаксис). Изучение препроцессора также происходило по документации
                и по видеоурокам.
            </p>
        </div>
    )
